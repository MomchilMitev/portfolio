  ...
  return (
    <>
      <section className="info">
        <h2 className="info__title">Get in Touch</h2>
        <div className="info__divider">
          <p className="info__description">
            I’d love to hear about what you’re working on and how I could help.
            I’m currently looking for a new role and am open to a wide range of
            opportunities. My preference would be to find a position in a
            company in Munich. I’m a hard-working and positive person who will
          ...
          <section className="info__socials">
            <a
              ...
              href="https://github.com/momchilmitev"
              target="_blank"
              rel="noreferrer"
            >
            ...
            <a
              className="info__social"
              href="https://www.linkedin.com/in/momchil-mitev-643b78181/"
              target="_blank"
              rel="noreferrer"
            >
